<?php
/*
	Template Name: Partnerpage layout
	Template Post Type: page
*/
get_header();

if ( class_exists( 'ACF' ) ) {
	$partner_blocks = get_field( 'partner_flexible_content' );
	if ( ! empty( $partner_blocks ) && is_array( $partner_blocks ) ) {
		foreach ( $partner_blocks as $key => $block ){
