<?php    
    ...
    $type_id = preg_replace('/\s+/', '-', trim($type_name));
...
<div class="tab-pane fade" id="<?php echo esc_attr( $type_id ); ?>" role="tabpanel" aria-labelledby="<?php echo esc_attr( $type_id ); ?>-tab">
        ...
        <div class="row">
                        ...
                        <div class="term__loans">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="text" id="amount-<?php echo esc_attr( $type_id ); ?>" class="form-control" data-index=0 value="$100,000">
                                    </div>
                                </div>
                        ...
                        <div class="term__loans">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                    <input type="number" min="1" max="100" id="residual-<?php echo esc_attr( $type_id ); ?>" class="form-control" data-index="0" value="40">
                                    </div>
                                </div>
                    ...
                    <div class="range-output">
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="payment-<?php echo esc_attr( $type_id ); ?>" <?php echo $payment;?>>
            ...
            <div class="col-lg-5 offset-lg-1 col-md-6">
                <div class="calculator__output">
                    ...
                    <a class="wpcf7-form-control wpcf7-submit btn btn--red--dust btn--big" id="quote-<?php echo esc_attr( $type_id ); ?>" href="<?php echo esc_url($url); ?>">Get refined quote</a>
                </div>
            </div>
        </div>
    </div>